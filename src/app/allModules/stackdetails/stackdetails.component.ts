...
export class StackDetailsComponent implements OnInit, OnDestroy {
  ...
  GetAll20EmptyReportsCount(): void {
    this._stackDetailsService.GetAll20EmptyReportsCount(this.authenticationDetails.userID).subscribe(
      (data) => {
  ...
  GetAll40EmptyReportsCount(): void {
    this._stackDetailsService.GetAll40EmptyReportsCount(this.authenticationDetails.userID).subscribe(
      (data) => {
  ...
  GetAll20FilledReportsCount(): void {
    this._stackDetailsService.GetAll20FilledReportsCount(this.authenticationDetails.userID).subscribe(
      (data) => {
  ...
  GetAll40FilledReportsCount(): void {
    this._stackDetailsService.GetAll40FilledReportsCount(this.authenticationDetails.userID).subscribe(
      (data) => {
  ...
  GetAll20DamagedEmptyReportsCount(): void {
    this._stackDetailsService.GetAll20DamagedEmptyReportsCount(this.authenticationDetails.userID).subscribe(
      (data) => {
  ...
  GetAll40DamagedEmptyReportsCount(): void {
    this._stackDetailsService.GetAll40DamagedEmptyReportsCount(this.authenticationDetails.userID).subscribe(
      (data) => {
  ...
  GetAllReportsBasedOnFilter(): void {
    if (this.reportFormGroup.valid) {
      ...
      if (this.reportFilters.CONTAINER !== '' && this.reportFilters.CUSTOMER === '' && (this.reportFilters.FROMDATE.toString() === '' && this.reportFilters.TODATE.toString() === '')) {
        ...
        this._stackDetailsService.GetAllReportsBasedOnContainerFilter(this.reportFilters)
          .subscribe((data) => {
            this.AllStackDetails = data as StackDetails[];
            if (this.AllStackDetails.length > 0) {
              this.dataSource = new MatTableDataSource(this.AllStackDetails);
      ...
      // tslint:disable-next-line:max-line-length
        ...
        // this.authenticationDetails.userID, CUSTOMER, FROMDATE, TODATE
        this._stackDetailsService.GetAllReportsBasedOnCustomerFilter(this.reportFilters)
          .subscribe((data) => {
            this.AllStackDetails = data as StackDetails[];
            if (this.AllStackDetails.length > 0) {
              this.dataSource = new MatTableDataSource(this.AllStackDetails);
      ...
      // tslint:disable-next-line:max-line-length
        ...
        // this.authenticationDetails.userID, CUSTOMER, FROMDATE, TODATE
        this._stackDetailsService.GetAllReportsBasedOnDateFilter(this.reportFilters)
          .subscribe((data) => {
            this.AllStackDetails = data as StackDetails[];
            if (this.AllStackDetails.length > 0) {
              this.dataSource = new MatTableDataSource(this.AllStackDetails);
  ...
  GetAllCustomers(): void {
    this._stackDetailsService.GetAllCustomers(this.authenticationDetails.userID).subscribe((data) => {
      if (data) {
  ...
  GetAllContainers(): void {
    this._stackDetailsService.GetAllContainers(this.authenticationDetails.userID).subscribe((data) => {
      if (data) {
  ...
  GetAll20EmptyReports(): void {
    this._stackDetailsService.GetAll20EmptyReports(this.authenticationDetails.userID).subscribe(
      (data) => {
        this.AllStackDetails = data as StackDetails[];
        if (this.AllStackDetails.length > 0) {
          this.dataSource = new MatTableDataSource(this.AllStackDetails);
  ...
  GetAll40EmptyReports(): void {
    this._stackDetailsService.GetAll40EmptyReports(this.authenticationDetails.userID).subscribe(
      (data) => {
        this.AllStackDetails = data as StackDetails[];
        if (this.AllStackDetails.length > 0) {
          this.dataSource = new MatTableDataSource(this.AllStackDetails);
  ...
  GetAll20FilledReports(): void {
    this._stackDetailsService.GetAll20FilledReports(this.authenticationDetails.userID).subscribe(
      (data) => {
        this.AllStackDetails = data as StackDetails[];
        if (this.AllStackDetails.length > 0) {
          this.dataSource = new MatTableDataSource(this.AllStackDetails);
  ...
  GetAll40FilledReports(): void {
    this._stackDetailsService.GetAll40FilledReports(this.authenticationDetails.userID).subscribe(
      (data) => {
        this.AllStackDetails = data as StackDetails[];
  ...
  GetAll20DamagedEmptyReports(): void {
    this._stackDetailsService.GetAll20DamagedEmptyReports(this.authenticationDetails.userID).subscribe(
      (data) => {
        this.AllStackDetails = data as StackDetails[];
        if (this.AllStackDetails.length > 0) {
          this.dataSource = new MatTableDataSource(this.AllStackDetails);
  ...
  GetAll40DamagedEmptyReports(): void {
    this._stackDetailsService.GetAll40DamagedEmptyReports(this.authenticationDetails.userID).subscribe(
      (data) => {
        this.AllStackDetails = data as StackDetails[];
        if (this.AllStackDetails.length > 0) {
          this.dataSource = new MatTableDataSource(this.AllStackDetails);
  ...
  loadSelectedStackDetails(value: string): void {
