...
import { GatewayStatusDetails, ReportFilters } from 'app/models/gatewayStatus';
...
export class GatewayStatusComponent implements OnInit, OnDestroy {
  ...
  // tslint:disable-next-line:max-line-length 'PLANT', 'PLANTNAME', 'STATION','IP',
  displayedColumns: string[] = ['GATEWAY_ID', 'BLE_DETAILS', 'CREATED_ON', 'MODIFIED_ON', 'ON_OFF_STATUS'];
