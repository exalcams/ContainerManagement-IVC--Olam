...
export class CReportComponent implements OnInit, OnDestroy {
  ...
  displayedColumns: string[] = ['CONTAINER_NO', 'CONTAINER_SIZE', 'BLE_ID', 'CUSTOMER_NO', 'CUSTOMER_NAME',
    'SALES_CONTRACT_NO', 'BOOKING_REFERENCE', 'CONTAINER_TYPE', 'TYPE', 'COLOR', 'IS_DAMAGE', 'CLEAN_TYPE'];
