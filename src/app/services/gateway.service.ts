...
export class GatewayService {
  ...
  GetAllVendorsOrVehicleNos(option: string): Observable<any[] | string> {
    return this._httpClient.get<any[]>(`${this.baseAddress}api/G_Queue/GetAllVendorOrVehicleNos?Option=` + option)
